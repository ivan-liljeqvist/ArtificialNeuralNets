...
1) What is the lower bound for the number of training examples, N?
    ...
    N has to be at least =n. Otherwise the least square will not work because the system will be underdetermined and have
    zero or infinite number of solutions.
    
    
2) What happens with the error if N = n? Why?

    The error is zero if there is any solution. 
...
4) During training we use an error measure de ned over the training exam- ples. 
